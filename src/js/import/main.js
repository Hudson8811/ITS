...
function initMainSlider() {
  const sliderEl = document.querySelector('[data-js="mainSlider"]');
  if (!sliderEl) return;

  const tabs = document.querySelectorAll('[data-js="mainSliderTab"]');
  ...
  function activateTabBySlide(swiper) {
    ...
    const activeTab = [...tabs].find(tab => tab.getAttribute('data-target') === activeId);
    if (activeTab) {
